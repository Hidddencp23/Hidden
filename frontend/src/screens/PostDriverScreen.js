...
import { View, Text, StyleSheet, TextInput, TouchableOpacity, DevSettings } from 'react-native';
...
const PostDriverScreen = ({ navigation }) => {
    const { user } = useAuth();
    ...
    return (
        <View style={styles.driverScreen}>
            <View style={styles.driverForm}>
                <Text style={styles.driverHeader}>Post offering as a driver</Text>
                <Text>Source</Text>
                <TextInput
...
export default PostDriverScreen;